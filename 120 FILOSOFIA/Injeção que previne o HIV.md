...
informacoes:
  comparacao:
    lenacapavir:
      eficacia: 96% em comparação com a população geral
      forma: injetável
      frequencia: semestral
    prEP_atual:
      eficacia: quase zero risco
      forma: comprimidos orais
      frequencia: diária
  definicao_vacina:
    diferenca: lenacapavir não induz resposta imunológica, é um antiviral
  desafios:
    acesso: exclusão de países com altas taxas de infecção
    custo: 28 mil dólares é insano
  estudos:
  - nome: Purpose-1
    participantes: 5,3 mil mulheres cisgênero
    resultados: nenhuma infecção
  - nome: Purpose-2
    participantes: 3,3 mil diversos
    resultados: 2 casos de HIV com lenacapavir, 9 com PrEP oral
  medicamento:
    aprovado_em: EUA
    custo_producao: 25 dólares (R$ 140)
    custo_venda: 28 mil dólares (R$ 156 mil)
    eficacia: quase 100%
    forma: injetável
    frequencia: a cada seis meses
    nome: lenacapavir
...
Por outro lado, a sociedade quer as vidas salvas, não o dinheiro para o fabricante. Como conjugar ambos os desejos?


# Injeção que previne o HIV: estudo inédito mostra que droga de última geração poderia custar R$ 140; farmacêutica cobra R$ 156 mil
(https://oglobo.globo.com/saude/noticia/2025/07/17/injecao-que-previne-o-hiv-estudo-inedito-mostra-que-droga-de-ultima-geracao-poderia-custar-r-140-farmaceutica-cobra-r-156-mil.ghtml)

Um novo estudo na revista científica The Lancet estimou que o medicamento injetável a cada seis meses que previne em quase 100% a infecção pelo [HIV](https://oglobo.globo.com/tudo-sobre/assunto/hiv/), o lenacapavir, poderia ser vendido por apenas 25 dólares (o equivalente a cerca de R$ 140 na cotação atual) para uma pessoa a cada ano.
