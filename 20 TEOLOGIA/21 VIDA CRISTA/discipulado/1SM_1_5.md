...
topic_classification:
  version: '2.0'
  classified_at: '2026-03-06T07:41:13.978446+00:00'
  model: gemini-2.5-flash-lite
  topics:
  - name: voto_de_ana_e_fidelidade
    weight: 9
    confidence: 0.95
  - name: esterilidade_feminina_na_antiguidade
    weight: 7
    confidence: 0.85
  - name: origem_e_significado_do_nome_samuel
    weight: 6
    confidence: 0.8
  - name: deus_dos_fracos_e_necessitados
    weight: 8
    confidence: 0.9
  - name: soberania_divina_e_controle_universal
    weight: 8
    confidence: 0.92
  - name: corrupcao_sacerdotal_e_analogias_contemporaneas
    weight: 7
    confidence: 0.88
  - name: recompensa_divina_pela_entrega_e_fidelidade
    weight: 9
    confidence: 0.94
  - name: raridade_das_visoes_e_agir_sobrenatural_deus
    weight: 7
    confidence: 0.87
  - name: importancia_da_disciplina_filial_e_responsabilidade_dos_lideres
    weight: 9
    confidence: 0.93
  - name: superioridade_de_jeova_sobre_outros_deuses
    weight: 8
    confidence: 0.91
  cdu_primary: '222.4'
  cdu_secondary: []
  cdu_description: Livros históricos do Antigo Testamento - Livro de Samuel
---
Nota Sem Título
