...
topic_classification:
  version: '2.0'
  classified_at: '2026-03-06T07:40:10.861113+00:00'
  model: gemini-2.5-flash-lite
  topics:
  - name: salvacao_pela_graca
    weight: 10
    confidence: 0.98
  - name: fe_em_cristo_jesus
    weight: 9
    confidence: 0.97
  - name: dom_de_deus
    weight: 8
    confidence: 0.96
  - name: boas_obras_como_fruto
    weight: 7
    confidence: 0.95
  - name: regeneracao_pelo_espirito_santo
    weight: 6
    confidence: 0.94
  - name: aperfeicoamento_dos_santos
    weight: 5
    confidence: 0.93
  - name: vida_eterna_perseveranca
    weight: 7
    confidence: 0.92
  - name: conhecimento_de_deus
    weight: 6
    confidence: 0.91
  - name: inspiracao_divina_das_escrituras
    weight: 5
    confidence: 0.9
  - name: discipulado_e_testemunho
    weight: 8
    confidence: 0.89
  cdu_primary: '234.2'
  cdu_secondary:
  - '230.3'
  - '248.2'
  cdu_description: Teologia cristã - Salvação. Doutrina da salvação. Graça. Fé. Obras. Regeneração. Vida eterna. Conhecimento de Deus. Escatologia. Vida cristã.
---
Ef 2:8_10
