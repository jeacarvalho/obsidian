...
topic_classification:
  version: '2.0'
  classified_at: '2026-03-06T07:41:44.463728+00:00'
  model: gemini-2.5-flash-lite
  topics:
  - name: proibicao_piores_formas_trabalho_infantil
    weight: 10
    confidence: 0.98
  - name: eliminacao_trabalho_infantil
    weight: 9
    confidence: 0.97
  - name: convencao_oit_182
    weight: 8
    confidence: 0.96
  - name: acao_imediata_trabalho_infantil
    weight: 7
    confidence: 0.94
  - name: definicao_crianca_menor_18_anos
    weight: 6
    confidence: 0.93
  - name: escravidao_infantil
    weight: 7
    confidence: 0.92
  - name: trafico_de_criancas
    weight: 7
    confidence: 0.91
  - name: trabalho_forcado_infantil
    weight: 7
    confidence: 0.9
  - name: trabalho_perigoso_para_criancas
    weight: 6
    confidence: 0.89
  - name: reabilitacao_social_criancas_trabalhadoras
    weight: 5
    confidence: 0.88
  cdu_primary: '331.59'
  cdu_secondary:
  - 341.241.1
  - '364.66'
  cdu_description: Trabalho infantil. Proibição e eliminação das piores formas. Convenções internacionais. Direitos da criança. Proteção social.
---
**CONVENÇÃO Nº 182  
**
...
RECORDANDO a Declaração da OIT relativa aos princípios e direitos fundamentais no trabalho e seu seguimento, adotada pela Conferência Internacional do Trabalho em sus 86ª reunião, celebrada em 1998;  
...
1. Os tipos de trabalhos a que se refere o Artigo 3, d), deverão ser determinados pela legislação nacional ou pela autoridade competente, após consulta às organizações de empregadores e de trabalhadores interessadas e levando em consideração as normas internacionais na matéria, em particular os parágrafos 3 e 4 da [Recomendação](https://www.trt2.jus.br/geral/tribunal2/LEGIS/CLT/OIT/OIT_182.html#Recomendacao_190) sobre as piores formas de trabalho infantil, 1999.  
...
a) a ratificação, por um Membro, da nova Convenção revisora implicará _ipso jure_ a denúncia imediata desta Convenção, não obstante os dispositivos contidos no Artigo 11, desde que a nova Convenção revisora tenha entrado em vigor;  
