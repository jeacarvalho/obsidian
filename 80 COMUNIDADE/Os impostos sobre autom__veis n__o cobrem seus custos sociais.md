---
created: 2021-09-24T11:20:00 (UTC -03:00)
tags: []
...
No Brasil, a Associação Nacional dos Transportes Público (ANTP) encontrou externalidades negativas mais gastos com infraestrutura produzidos pelo transporte motorizado individual (motos e carros) de [até R$ 136 bilhões](http://files.antp.org.br/simob/sistema-de-informacoes-da-mobilidade--simob--2018.pdf) para o ano de 2018, aferindo apenas as perdas com acidentes, poluição, ruídos e manutenção das vias em cidades com mais de 60 mil habitantes.

![Trânsito na Marginal Pinheiros, São Paulo](https://caosplanejado.com/wp-content/uploads/2021/09/marginal-pinheiros.jpg)

Marginal Pinheiros, São Paulo. [(Imagem: Rovena Rosa/Agência Brasil)](https://agenciabrasil.ebc.com.br/foto/2021-09/transito-na-marginal-pinheiros-1630699993-0)
...
O segundo grande equívoco se dá em considerar o valor integralmente arrecadado por via da tributação. Em 2018, os impostos sobre combustíveis e automóveis [totalizaram R$ 175 bilhões,](https://www.gov.br/receitafederal/pt-br/acesso-a-informacao/dados-abertos/receitadata/estudos-e-tributarios-e-aduaneiros/estudos-e-estatisticas/carga-tributaria-no-brasil/carga-tributaria-no-brasil-capa) sendo R$ 43 bilhões em IPVA, R$ 86 bilhões em ICMS/Combustível, R$ 37 bilhões em ICMS/Automóvel (valor este de 2015), R$ 5,7 bilhões de IPI-Automóvel e R$ 3,9 bilhões de CIDE-Combustível.

Todavia, há que se lembrar que sobre a maioria dos bens e atividades econômicas incidem impostos, os quais não seguem o princípio do benefício. De forma que [alguns autores defendem](https://www.vtpi.org/tca/tca01.pdf)%20(https://uspirg.org/reports/usp/do-roads-pay-themselves) que o mais correto seja utilizar apenas o que é pago excepcionalmente, como IPVA, as tarifas de Zona Azul e a Cide-Combustível.
...
A título de exemplo, [hoje a carga tributária para a compra de um carro 1.0 gira em torno de 34%, enquanto a tributação média para compra de uma bicicleta seria de 46%.](https://impostometro.com.br/home/relacaoprodutos) Nesse caso, a tributação sobre a compra de um carro se mostra mais benéfica relativamente à bicicleta, o que torna esses 12% a menos um benefício, ou, dito de outra forma, um subsídio para quem pretende adquirir automóvel.
...
O passo seguinte é estimar a arrecadação, caso todas as alíquotas convergissem para a média. Cálculos preliminares realizados a partir do [volume de combustível vendido,](http://www.anp.gov.br/dados-abertos-anp/vendas-derivados-petroleo-biocombustiveis) do [preço médio praticado e das alíquotas de ICMS em cada estado](https://www.fecombustiveis.org.br/tributacao) indicam um possível excesso de arrecadação de ICMS/Combustível no montante de R$ 13 bilhões.

![Autoestrada Lagoa-Barra, Rio de Janeiro](https://caosplanejado.com/wp-content/uploads/2021/09/rio.jpg)

Autoestrada Lagoa-Barra, Rio de Janeiro. [(Imagem: Alexandre Macieira/Riotur)](https://www.flickr.com/photos/riotur/8446936555/)

Por sua vez, observou-se que o IPI sobre automóveis tende a ser [maior que a média,](http://repositorio.ipea.gov.br/bitstream/11058/4114/2/PPE_v45_n01_Imposto.pdf) mas não o suficiente para compensar o menor ICMS sobre a venda de automóveis, de forma que se optou por não considerar o montante arrecadado por ambos.
...
Para se ter uma ideia, as externalidades negativas calculadas pela ANTP representaram 1,9% do [[PIB]], enquanto cálculos mais abrangentes realizados para os EUA [estimam externalidades de até 8% do PIB.](https://www.vtpi.org/tca/tca06.pdf) De forma que se as externalidades não calculadas para o Brasil forem similares às dos EUA, os motoristas estariam pagando somente 10% dos danos/perdas causados à sociedade.
...
[Quero apoiar](https://caosplanejado.com/apoie/)
